...
- The credit to [Nnenna Ndukwe](https://github.com/nnennandukwe) in `SKILL.md` and `README.md` is load-bearing. Structure adapted from her Apache-2.0 work; keep the attribution if you keep the structure.
